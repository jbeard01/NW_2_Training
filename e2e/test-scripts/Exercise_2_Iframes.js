...
module.exports = {
        ...
        *** NOTE: Page Object Functions (PO Function) should not contain hard assertions! ***
        ...
        Exercise 2: Iframes 
            ...
            Script: Iframe - verify text page object function
                ...
                2) Using provided page object function, navigate to the Iframes page
                3) Complete a page object function (verifyElText) that does the following:
            ...
            Script: Iframe - verify text page object function
                1) Using provided page object function, navigate to the site under test
                2) Using provided page object function, navigate to the Iframes page
                3) Complete a page object function (verifyElFont) that does the following:
                    - Verify the Title and Subtitle css properties
                        1) font size
                        2) font weight
            ...
            Script: Iframe - element interaction page object function
                1) Using provided page object function, navigate to the site under test
                2) Using provided page object function, navigate to the Iframes page
                3) Complete a page object function (verifyBtnBehavior) that does the following:
    ...
    */
    ...
    'Exercise 2: Iframe - verify text with PO function': (browser) => {
        ...
        // Use the correct page object funtions to navigate to the test site, then focus the iframe
        

        // Verify Iframe title and subtitle are correct
        // Complete and use the correct page object function to verify element text is correct
    ...
    'Exercise 2: Iframe - css properties with PO function': (browser) => {
        ...
        // Complete and use the correct page object function to verify element font size and weight
    ...
    'Exercise 2: Iframe - element interaction with PO function': (browser) => {
        ...
        // Complete and use the page object function to verify element behavior
