...
module.exports = {
    ...
    Using the provided examples, Complete a Page Object Function that will complete the test. 
    ...
    Use the following parameters for the test scripts:
        ...
        Exercise 3: Forms
            Script: Negative test - Login without registration
                ...
                3) Complete a page object function to do the following:
            ...
            Script: Complete registration form
                1) Using provided page object function, navigate to the test site URL
                2) Complete a page object function to do the following:
            ...
            Script: Login with registration credentials
                1) Using provided page object function, navigate to the site under test
                2) Using provided page object function, navigate to the forms menu and select Login
    ...
    */
    ...
    'Exercise 3: Forms - Negative test - Login without registration with PO function': (browser) => {
        ...
        // Use the correct page object funtions to navigate to the test site, then navigate to the login page of the forms menu

        // Complete and use the page object function to attempt login (before registration)
    ...
    'Exercise 3: Forms - Complete registration form with PO function': (browser) => {
        ...
        // Use the correct page object funtions to navigate to the test site

        // Complete and use the page object function to navigate to the registration page of the forms menu
        ...
        // Fill out the 
        // Complete and use the page object function to complete a registration form
        ...
        browser.waitForElementVisible(constants.SELECTORS.CSS, '[id="message"]');
        browser.assert.textEquals('[id="message"]', "The account has been successfully Completed!", "Alert message text is correct!");
    },
    ...
    'Exercise 3: Forms - Login with registration credentials with PO function': (browser) => {
        ...
        // Use the existing page object function previously completed to fill out the login form after registration
